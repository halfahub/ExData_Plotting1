...
plot4 <- function() {
        ...
        with(hc, {
                ...
                ## XY-plot #1 "Global active power" without the x-axis labels
                ...
                ## XY-plot #2 "Global active power" without the x-axis labels
                plot(time,Voltage,type="l",xlab="datetime",ylab="Voltage",xaxt='n')
                ## Plotting x-axis labels
                axis.POSIXct(1, at = seq(r[1], r[2], by = "day"), format = "%a")
                                               
                ## XY-plot #3 Sub_metering_1 without the x-axis labels
                ...
                ## XY-plot #4 "Global reactive power" without the x-axis labels
                plot(time,Global_reactive_power,type="l",xlab="datetime",ylab="Global Reactive Power",xaxt='n')
                ## Plotting x-axis labels
                axis.POSIXct(1, at = seq(r[1], r[2], by = "day"), format = "%a")
        ...
        dev.off()
        print("The diagram is saved in plot4.png")
        par(mfrow = c(1,1))
}